...
@export var choice_icon: String = "ChoiceIcon"
@export var choice_description: String = "ChoiceDescription"
@export var choice_image_texture: Resource
