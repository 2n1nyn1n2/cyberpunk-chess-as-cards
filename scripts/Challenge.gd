...
@export var challenge_tile: String = "Challenge Tile"
@export var challenge_icon: String = "x"
...
func update_ui():
	...
	var challenge_icon_label = $ChallengeIcon
	...
	if challenge_icon_label:
		challenge_icon_label.text = "%s" % [challenge_icon]
